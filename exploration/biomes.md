...
| バイオーム | ギアレベル | 難易度 | 特徴 |
|-----------|-----------|--------|------|
| **Coastal Jungle（沿岸ジャングル）** | Lv 1〜5 | 序盤 | チュートリアル的なバイオーム |
| **Foothills（丘陵地帯）** | Lv 6〜10 | 中盤 | 鉄・薬草が解放される |
| **Cursed Swamps（呪われた沼地）** | Lv 11〜15 | 終盤 | 高難度・古代遺跡・希少素材 |

**ボスを倒すと次バイオームのギア製作が解放**される。

---

## Coastal Jungle（沿岸ジャングル）
**推奨ギアレベル: 1〜5**
...
1. **千斬のレイピア（Rapier of a Thousand Cuts）** — 赤い旗がついた木の近くを掘る（埋蔵金）
...
| 資源 | 入手方法 | 備考 |
|------|---------|------|
| 鉄鉱石（Iron Ore） | Foothills の Mine 専用 | **Coastal では精錬不可** |
| Medicinal Herb（薬草） | 草原に自生 | Alchemy 材料 |
| Ironwood | ジャングルタイプの島で伐採 | 上位木材 |

### 特記事項

- **鉄（Iron）はこのバイオームでのみ採掘・精錬可能**。鉄製ツール・武器への昇格にはここが必須
- 第2島到着直後に **Bonfire・Tent・ファストトラベルベル** を設置する習慣をつける
- **Misty Orchid（霧の蘭）** を発見すると **Alchemy Table（錬金テーブル）** が解放 → ポーション自作が可能になる

### ボス

情報収集中。撃破で Cursed Swamps のギア（Lv11〜）が解放。

---

## Cursed Swamps（呪われた沼地）
**推奨ギアレベル: 11〜15**

最終バイオーム。高難度・独自の生態系・古代文明の遺跡が点在する。

### 主な資源

| 資源 | 入手方法 |
|------|---------|
| Ancient Scraps（古代の破片） | 沼の遺跡で採取 |
| Ancient Steel Shard | 遺跡・古代金庫 |
| Ancient Relic Fragment | 遺跡・高レベルダンジョン |
| Aquamarine（アクアマリン） | **Ancient Vault（古代金庫）限定** |
| Cane Sugar | 古代遺跡周辺 |
| Bromeliad | 沼地に自生（Alchemy 素材） |

### ボス

情報収集中。Swamp Creature 系のボスが登場する可能性あり。
