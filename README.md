...
> 本サイトは Windrose の実プレイと海外コミュニティ（Steam / Reddit / 公式サイト等）の情報を独自に検証・整理した日本語攻略情報です。情報源は各ページ下部および「情報源・参考リンク」ページを参照してください。

---

## ⚠️ 【重要】SSD 寿命に関わる既知の不具合

Windrose は現在、**通常プレイ中に SSD へ毎時 20〜60GB の異常な書き込みを発生させる不具合**があります（実セーブデータは約 30MB のみ）。開発者は問題を公式に認知しており次回パッチでの修正を予告していますが、**修正までは SSD の保証 TBW を急速に消費する状態**です。

→ **詳細・回避策（Junction Link 手順）は [トラブルシューティング](troubleshooting.md) を参照してください**

> 本警告は修正パッチ配信を確認次第削除します。
...
- マルチプレイ: オンライン最大8人（4人以下推奨）/ ホスト型セッション
...
### 装備
- [装備概要](equipment/index.html) — [武器一覧](equipment/weapons.md) / [防具一覧](equipment/armor.md) / [ユニーク装備](equipment/uniques.md)
...
### 素材・資源
- [素材概要](resources/index.html) — [木材・石材](resources/wood-stone.md) / [鉱石・インゴット](resources/ores-ingots.md) / [植物・食材](resources/plants-food.md)

### 探索・ワールド
- [探索概要](exploration/index.html) — [バイオーム](exploration/biomes.md) / [島ガイド](exploration/islands.md) / [ダンジョン・POI](exploration/dungeons.md)

### 勢力・名声
- [勢力・名声](factions.md) — Insignia換算 / Rank閾値 / 各派閥ベンダー / NPCワーカー
