...
> 📌 **2026-04-30 パッチ（0.10.0.4.268）**: Boar の2段目コンボ攻撃のアニメーションが改善され、攻撃範囲が拡大した。従来「振り抜け」で抜けられた距離でも当たるようになっているため、距離取りの感覚を再調整する必要がある。
...
> 📌 **2026-04-30 パッチ（0.10.0.4.268）**: Alpha Wolf の出血効果が修正された（具体的な内容は公式パッチノートでは詳細未記載）。**掴まれ中の出血ダメージは無効化**された。
...
> 📌 **2026-04-30 パッチ（0.10.0.4.268）**: Drowned の遠距離攻撃に**音声キュー**が追加され、投射前に叫ぶようになった。乱戦中でも遠距離攻撃のタイミングを聴き分けられるようになっている。
